...
#ifndef KUNLUN_UTIL_H
#define KUNLUN_UTIL_H
...
const static block prs = Block::MakeBlock(2305843009213693951ULL, 2305843009213693951ULL);
const static uint64_t PR = 2305843009213693951;
static __m128i PRs = Block::MakeBlock(PR, PR);
